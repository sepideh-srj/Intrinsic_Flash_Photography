...
class DecomposeNet(nn.Module):
    ...
    def __init__(self, activation='tanh', features=64, backbone="efficientnet_lite3", exportable=True, input_channels=3, output_channels=1, align_corners=True, blocks={'expand': True}):
        ...
        self.pretrained = _make_pretrained_efficientnet_lite3(use_pretrained, in_chan=input_channels, exportable=exportable)
        ...
        self.scratch1.refinenet4 = FeatureFusionBlock_custom(features4, self.scratch1.activation, deconv=False, bn=False, expand=self.expand, align_corners=align_corners)
        self.scratch1.refinenet3 = FeatureFusionBlock_custom(features3, self.scratch1.activation, deconv=False, bn=False, expand=self.expand, align_corners=align_corners)
        self.scratch1.refinenet2 = FeatureFusionBlock_custom(features2, self.scratch1.activation, deconv=False, bn=False, expand=self.expand, align_corners=align_corners)
        self.scratch1.refinenet1 = FeatureFusionBlock_custom(features1, self.scratch1.activation, deconv=False, bn=False, align_corners=align_corners)
        ...
        self.scratch2.refinenet4 = FeatureFusionBlock_custom(features4, self.scratch2.activation, deconv=False, bn=False, expand=self.expand, align_corners=align_corners)
        self.scratch2.refinenet3 = FeatureFusionBlock_custom(features3, self.scratch2.activation, deconv=False, bn=False, expand=self.expand, align_corners=align_corners)
        self.scratch2.refinenet2 = FeatureFusionBlock_custom(features2, self.scratch2.activation, deconv=False, bn=False, expand=self.expand, align_corners=align_corners)
        self.scratch2.refinenet1 = FeatureFusionBlock_custom(features1, self.scratch2.activation, deconv=False, bn=False, align_corners=align_corners)
